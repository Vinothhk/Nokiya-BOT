...
class LineFollower(Node):
    def __init__(self):
        ...
        # Subscription to the ultrasonic sensor topic
        ...
        self.twist = Twist()
        self.obstacle_detected = False  # Flag to check if an obstacle is detected

    def range_callback(self, msg):
        distance = msg.range  # Access the range value
    ...
    def image_callback(self, msg):
        ...
        # if len(contours) == 0 or self.obstacle_detected:
        if len(contours) == 0 or self.obstacle_detected:
